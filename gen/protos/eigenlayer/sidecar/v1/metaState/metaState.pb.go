...
type KeyRotationScheduledTrigger struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ActivateAt    *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=activate_at,json=activateAt,proto3" json:"activate_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *KeyRotationScheduledTrigger) Reset() {
	*x = KeyRotationScheduledTrigger{}
	mi := &file_eigenlayer_sidecar_v1_metaState_metaState_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *KeyRotationScheduledTrigger) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KeyRotationScheduledTrigger) ProtoMessage() {}

func (x *KeyRotationScheduledTrigger) ProtoReflect() protoreflect.Message {
	mi := &file_eigenlayer_sidecar_v1_metaState_metaState_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KeyRotationScheduledTrigger.ProtoReflect.Descriptor instead.
func (*KeyRotationScheduledTrigger) Descriptor() ([]byte, []int) {
	return file_eigenlayer_sidecar_v1_metaState_metaState_proto_rawDescGZIP(), []int{2}
}

func (x *KeyRotationScheduledTrigger) GetActivateAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ActivateAt
	}
	return nil
...
type MetaStateChange struct {
	...
	//	*MetaStateChange_KeyRotationScheduledTrigger
...
func (x *MetaStateChange) GetKeyRotationScheduledTrigger() *KeyRotationScheduledTrigger {
	if x != nil {
		if x, ok := x.Change.(*MetaStateChange_KeyRotationScheduledTrigger); ok {
			return x.KeyRotationScheduledTrigger
		}
	}
	return nil
}
...
type MetaStateChange_KeyRotationScheduledTrigger struct {
	KeyRotationScheduledTrigger *KeyRotationScheduledTrigger `protobuf:"bytes,2,opt,name=key_rotation_scheduled_trigger,json=keyRotationScheduledTrigger,proto3,oneof"`
}

func (*MetaStateChange_GenerationReservationCreated) isMetaStateChange_Change() {}

func (*MetaStateChange_KeyRotationScheduledTrigger) isMetaStateChange_Change() {}
...
var file_eigenlayer_sidecar_v1_metaState_metaState_proto_rawDesc = string([]byte{
	...
	,
	...
	,
	...
	,
})
...
var file_eigenlayer_sidecar_v1_metaState_metaState_proto_goTypes = []any{
	...
	(*KeyRotationScheduledTrigger)(nil),  // 2: eigenlayer.sidecar.v1.metaState.KeyRotationScheduledTrigger
...
var file_eigenlayer_sidecar_v1_metaState_metaState_proto_depIdxs = []int32{
	...
	4, // 1: eigenlayer.sidecar.v1.metaState.KeyRotationScheduledTrigger.activate_at:type_name -> google.protobuf.Timestamp
	...
	2, // 3: eigenlayer.sidecar.v1.metaState.MetaStateChange.key_rotation_scheduled_trigger:type_name -> eigenlayer.sidecar.v1.metaState.KeyRotationScheduledTrigger
...
func file_eigenlayer_sidecar_v1_metaState_metaState_proto_init() {
	...
	file_eigenlayer_sidecar_v1_metaState_metaState_proto_msgTypes[3].OneofWrappers = []any{
		...
		(*MetaStateChange_KeyRotationScheduledTrigger)(nil),
	}
	type x struct{}
