...
var file_eigenlayer_sidecar_v1_slashing_common_proto_rawDesc = string([]byte{
...
var (
	...
	file_eigenlayer_sidecar_v1_slashing_common_proto_rawDescData []byte
)
...
func file_eigenlayer_sidecar_v1_slashing_common_proto_rawDescGZIP() []byte {
	file_eigenlayer_sidecar_v1_slashing_common_proto_rawDescOnce.Do(func() {
		file_eigenlayer_sidecar_v1_slashing_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eigenlayer_sidecar_v1_slashing_common_proto_rawDesc), len(file_eigenlayer_sidecar_v1_slashing_common_proto_rawDesc)))
	})
...
func file_eigenlayer_sidecar_v1_slashing_common_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eigenlayer_sidecar_v1_slashing_common_proto_rawDesc), len(file_eigenlayer_sidecar_v1_slashing_common_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
