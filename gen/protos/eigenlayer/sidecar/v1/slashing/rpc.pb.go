...
var file_eigenlayer_sidecar_v1_slashing_rpc_proto_rawDesc = []byte{
...
func file_eigenlayer_sidecar_v1_slashing_rpc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eigenlayer_sidecar_v1_slashing_rpc_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_eigenlayer_sidecar_v1_slashing_rpc_proto_rawDesc = nil
