...
var file_eigenlayer_sidecar_v1_protocol_rpc_proto_rawDesc = string([]byte{
	...
	0x74, 0x6f, 0x32, 0xfd, 0x19, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12,
	...
	,
...
var file_eigenlayer_sidecar_v1_protocol_rpc_proto_goTypes = []any{
	...
	(*ListWithdrawalsForStrategiesRequest)(nil),           // 13: eigenlayer.sidecar.v1.protocol.ListWithdrawalsForStrategiesRequest
	(*GetRegisteredAvsForOperatorResponse)(nil),           // 14: eigenlayer.sidecar.v1.protocol.GetRegisteredAvsForOperatorResponse
	(*GetDelegatedStrategiesForOperatorResponse)(nil),     // 15: eigenlayer.sidecar.v1.protocol.GetDelegatedStrategiesForOperatorResponse
	(*GetOperatorDelegatedStakeForStrategyResponse)(nil),  // 16: eigenlayer.sidecar.v1.protocol.GetOperatorDelegatedStakeForStrategyResponse
	(*GetDelegatedStakersForOperatorResponse)(nil),        // 17: eigenlayer.sidecar.v1.protocol.GetDelegatedStakersForOperatorResponse
	(*GetStakerSharesResponse)(nil),                       // 18: eigenlayer.sidecar.v1.protocol.GetStakerSharesResponse
	(*GetEigenStateChangesResponse)(nil),                  // 19: eigenlayer.sidecar.v1.protocol.GetEigenStateChangesResponse
	(*ListStrategiesResponse)(nil),                        // 20: eigenlayer.sidecar.v1.protocol.ListStrategiesResponse
	(*ListStakerStrategiesResponse)(nil),                  // 21: eigenlayer.sidecar.v1.protocol.ListStakerStrategiesResponse
	(*GetStrategyForStakerResponse)(nil),                  // 22: eigenlayer.sidecar.v1.protocol.GetStrategyForStakerResponse
	(*ListStakerQueuedWithdrawalsResponse)(nil),           // 23: eigenlayer.sidecar.v1.protocol.ListStakerQueuedWithdrawalsResponse
	(*ListStrategyQueuedWithdrawalsResponse)(nil),         // 24: eigenlayer.sidecar.v1.protocol.ListStrategyQueuedWithdrawalsResponse
	(*ListOperatorQueuedWithdrawalsResponse)(nil),         // 25: eigenlayer.sidecar.v1.protocol.ListOperatorQueuedWithdrawalsResponse
	(*ListOperatorStrategyQueuedWithdrawalsResponse)(nil), // 26: eigenlayer.sidecar.v1.protocol.ListOperatorStrategyQueuedWithdrawalsResponse
...
var file_eigenlayer_sidecar_v1_protocol_rpc_proto_depIdxs = []int32{
	...
	13, // 13: eigenlayer.sidecar.v1.protocol.Protocol.ListWithdrawalsForStrategies:input_type -> eigenlayer.sidecar.v1.protocol.ListWithdrawalsForStrategiesRequest
	14, // 14: eigenlayer.sidecar.v1.protocol.Protocol.GetRegisteredAvsForOperator:output_type -> eigenlayer.sidecar.v1.protocol.GetRegisteredAvsForOperatorResponse
	15, // 15: eigenlayer.sidecar.v1.protocol.Protocol.GetDelegatedStrategiesForOperator:output_type -> eigenlayer.sidecar.v1.protocol.GetDelegatedStrategiesForOperatorResponse
	16, // 16: eigenlayer.sidecar.v1.protocol.Protocol.GetOperatorDelegatedStakeForStrategy:output_type -> eigenlayer.sidecar.v1.protocol.GetOperatorDelegatedStakeForStrategyResponse
	17, // 17: eigenlayer.sidecar.v1.protocol.Protocol.GetDelegatedStakersForOperator:output_type -> eigenlayer.sidecar.v1.protocol.GetDelegatedStakersForOperatorResponse
	18, // 18: eigenlayer.sidecar.v1.protocol.Protocol.GetStakerShares:output_type -> eigenlayer.sidecar.v1.protocol.GetStakerSharesResponse
	19, // 19: eigenlayer.sidecar.v1.protocol.Protocol.GetEigenStateChanges:output_type -> eigenlayer.sidecar.v1.protocol.GetEigenStateChangesResponse
	20, // 20: eigenlayer.sidecar.v1.protocol.Protocol.ListStrategies:output_type -> eigenlayer.sidecar.v1.protocol.ListStrategiesResponse
	21, // 21: eigenlayer.sidecar.v1.protocol.Protocol.ListStakerStrategies:output_type -> eigenlayer.sidecar.v1.protocol.ListStakerStrategiesResponse
	22, // 22: eigenlayer.sidecar.v1.protocol.Protocol.GetStrategyForStaker:output_type -> eigenlayer.sidecar.v1.protocol.GetStrategyForStakerResponse
	23, // 23: eigenlayer.sidecar.v1.protocol.Protocol.ListStakerQueuedWithdrawals:output_type -> eigenlayer.sidecar.v1.protocol.ListStakerQueuedWithdrawalsResponse
	24, // 24: eigenlayer.sidecar.v1.protocol.Protocol.ListStrategyQueuedWithdrawals:output_type -> eigenlayer.sidecar.v1.protocol.ListStrategyQueuedWithdrawalsResponse
	25, // 25: eigenlayer.sidecar.v1.protocol.Protocol.ListOperatorQueuedWithdrawals:output_type -> eigenlayer.sidecar.v1.protocol.ListOperatorQueuedWithdrawalsResponse
	26, // 26: eigenlayer.sidecar.v1.protocol.Protocol.ListOperatorStrategyQueuedWithdrawals:output_type -> eigenlayer.sidecar.v1.protocol.ListOperatorStrategyQueuedWithdrawalsResponse
	27, // 27: eigenlayer.sidecar.v1.protocol.Protocol.ListWithdrawalsForStrategies:output_type -> eigenlayer.sidecar.v1.protocol.ListWithdrawalsForStrategiesResponse
