...
var file_eigenlayer_sidecar_v1_protocol_rpc_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0x8d, 0x0b, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
	...
	0x6e, 0x67, 0x65, 0x73, 0x42, 0x98, 0x02, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x69, 0x67,
	0x65, 0x6e, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x73, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x2e,
	0x76, 0x31, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x42, 0x08, 0x52, 0x70, 0x63,
...
var file_eigenlayer_sidecar_v1_protocol_rpc_proto_goTypes = []any{
	...
	(*GetRegisteredAvsForOperatorResponse)(nil),          // 6: eigenlayer.sidecar.v1.protocol.GetRegisteredAvsForOperatorResponse
	(*GetDelegatedStrategiesForOperatorResponse)(nil),    // 7: eigenlayer.sidecar.v1.protocol.GetDelegatedStrategiesForOperatorResponse
	(*GetOperatorDelegatedStakeForStrategyResponse)(nil), // 8: eigenlayer.sidecar.v1.protocol.GetOperatorDelegatedStakeForStrategyResponse
...
var file_eigenlayer_sidecar_v1_protocol_rpc_proto_depIdxs = []int32{
	...
	6,  // 6: eigenlayer.sidecar.v1.protocol.Protocol.GetRegisteredAvsForOperator:output_type -> eigenlayer.sidecar.v1.protocol.GetRegisteredAvsForOperatorResponse
	7,  // 7: eigenlayer.sidecar.v1.protocol.Protocol.GetDelegatedStrategiesForOperator:output_type -> eigenlayer.sidecar.v1.protocol.GetDelegatedStrategiesForOperatorResponse
	8,  // 8: eigenlayer.sidecar.v1.protocol.Protocol.GetOperatorDelegatedStakeForStrategy:output_type -> eigenlayer.sidecar.v1.protocol.GetOperatorDelegatedStakeForStrategyResponse
	9,  // 9: eigenlayer.sidecar.v1.protocol.Protocol.GetDelegatedStakersForOperator:output_type -> eigenlayer.sidecar.v1.protocol.GetDelegatedStakersForOperatorResponse
	...
	11, // 11: eigenlayer.sidecar.v1.protocol.Protocol.GetEigenStateChanges:output_type -> eigenlayer.sidecar.v1.protocol.GetEigenStateChangesResponse
