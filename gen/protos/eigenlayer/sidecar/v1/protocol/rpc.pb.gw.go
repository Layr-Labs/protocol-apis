...
var filter_Protocol_ListWithdrawalsForStrategy_0 = &utilities.DoubleArray{Encoding: map[string]int{"strategyAddress": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}

func request_Protocol_ListWithdrawalsForStrategy_0(ctx context.Context, marshaler runtime.Marshaler, client ProtocolClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListWithdrawalsForStrategyRequest
		metadata runtime.ServerMetadata
		err      error
	)
	io.Copy(io.Discard, req.Body)
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Protocol_ListWithdrawalsForStrategy_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.ListWithdrawalsForStrategy(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_Protocol_ListWithdrawalsForStrategy_0(ctx context.Context, marshaler runtime.Marshaler, server ProtocolServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListWithdrawalsForStrategyRequest
		metadata runtime.ServerMetadata
		err      error
	...
	msg, err := server.ListWithdrawalsForStrategy(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterProtocolHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProtocolServer) error {
	...
	mux.Handle(http.MethodGet, pattern_Protocol_ListWithdrawalsForStrategy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/eigenlayer.sidecar.v1.protocol.Protocol/ListWithdrawalsForStrategy", runtime.WithHTTPPathPattern("/protocol/v1/strategies/{strategyAddress}/withdrawals"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Protocol_ListWithdrawalsForStrategy_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Protocol_ListWithdrawalsForStrategy_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterProtocolHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProtocolClient) error {
	...
	mux.Handle(http.MethodGet, pattern_Protocol_ListWithdrawalsForStrategy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/eigenlayer.sidecar.v1.protocol.Protocol/ListWithdrawalsForStrategy", runtime.WithHTTPPathPattern("/protocol/v1/strategies/{strategyAddress}/withdrawals"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Protocol_ListWithdrawalsForStrategy_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Protocol_ListWithdrawalsForStrategy_0            = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"protocol", "v1", "strategies", "strategyAddress", "withdrawals"}, ""))
)
...
var (
	...
	forward_Protocol_ListWithdrawalsForStrategy_0            = runtime.ForwardResponseMessage
)
