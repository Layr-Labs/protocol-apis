...
var file_eigenlayer_sidecar_v1_sidecar_rpc_proto_rawDesc = string([]byte{
	...
	0x6f, 0x74, 0x6f, 0x32, 0xdf, 0x04, 0x0a, 0x03, 0x52, 0x70, 0x63, 0x12, 0x9b, 0x01, 0x0a, 0x0e,
	...
	0x74, 0x72, 0x61, 0x63, 0x74, 0x42, 0x92, 0x02, 0x0a, 0x21, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x69,
...
var file_eigenlayer_sidecar_v1_sidecar_rpc_proto_goTypes = []any{
	...
	(*GetBlockHeightResponse)(nil), // 4: eigenlayer.sidecar.v1.sidecar.GetBlockHeightResponse
	(*GetStateRootResponse)(nil),   // 5: eigenlayer.sidecar.v1.sidecar.GetStateRootResponse
	(*AboutResponse)(nil),          // 6: eigenlayer.sidecar.v1.sidecar.AboutResponse
...
var file_eigenlayer_sidecar_v1_sidecar_rpc_proto_depIdxs = []int32{
	...
	4, // 4: eigenlayer.sidecar.v1.sidecar.Rpc.GetBlockHeight:output_type -> eigenlayer.sidecar.v1.sidecar.GetBlockHeightResponse
	5, // 5: eigenlayer.sidecar.v1.sidecar.Rpc.GetStateRoot:output_type -> eigenlayer.sidecar.v1.sidecar.GetStateRootResponse
	6, // 6: eigenlayer.sidecar.v1.sidecar.Rpc.About:output_type -> eigenlayer.sidecar.v1.sidecar.AboutResponse
	7, // 7: eigenlayer.sidecar.v1.sidecar.Rpc.LoadContract:output_type -> eigenlayer.sidecar.v1.sidecar.LoadContractResponse
